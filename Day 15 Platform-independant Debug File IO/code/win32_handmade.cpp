...
int CALLBACK WinMain(
	...
	LPVOID BaseAddress = 0;
				...
				GameMemory.TransientStorageSize = Gigabytes((uint64)4);//Memory to full 4 gigabytes without wrapping back to zero; C wants to push exact which makes it wrap unless we tell it we want 4 Gigabytes of 64bit space. Research: Intergral Promotion
