...
REM 64bit build
del *.pdb > NUL 2> NUL
cl %CommonCompilerFlags% ..\code\handmade.cpp -Fmhandmade.map -LD /link /PDB:handmade_%date:~-4,4%%date:~-10,2%%date:~-7,2%_%time:~3,2%%time:~3,2%%time:~6,2%.pdb /EXPORT:GameGetSoundSamples /EXPORT:GameGetUpdateRenderer
