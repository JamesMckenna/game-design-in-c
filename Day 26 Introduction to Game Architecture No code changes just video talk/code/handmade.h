...
struct game_input {
	...
	game_controller_input Controllers[5]; //1 Keyboard + 4 Gamepads
};
...
#define GAME_GET_UPDATE_RENDERER(name) void name(thread_context *Thread, game_memory *Memory, game_input *Input, game_offscreen_buffer *Buffer)
