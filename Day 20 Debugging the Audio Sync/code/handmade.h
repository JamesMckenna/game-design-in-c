...
internal void GameUpdateRenderer(game_memory *Memory, game_input *Input, game_offscreen_buffer *Buffer);

//This will have to be a very fast function call as in under a millisecond or two
